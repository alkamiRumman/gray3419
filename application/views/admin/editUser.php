					...
					<div class="row">
						...
						<div class="form-group col-md-6">
							...
							<input class="form-control" type="text" name="username" id="emailEdit"
								   value="<?= $data->username ?>" title="Leave it blank if not change">
						</div>
					</div>
					<div class="row">
						<div class="form-group col-md-6">
							...
							<select class="form-control" name="type" id="type" required>
								<option <?= $data->type == 'Police' ? 'selected' : '' ?> value="Police">Police</option>
								<option <?= $data->type == 'Insurers' ? 'selected' : '' ?> value="Insurers">Insurers
								</option>
								<option <?= $data->type == 'Traffic Court' ? 'selected' : '' ?> value="Traffic Court">
									Traffic Court
								</option>
							</select>
						</div>
