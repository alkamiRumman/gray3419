<div class="modal fade in" id="modal-default" style="display: block;overflow: auto;">
	<div class="modal-dialog modal-lg" style="width: 80%">
		<div class="modal-content">
			...
			<form role="form" action="<?= admin_url('updateDetail/' . $data->id) ?>" method="post"
				...
				<div class="modal-body">
					...
					<div class="row">
						...
						<div class="form-group col-md-3">
							...
							<select style="width: 100%" id="policeId" name="policeId"
									class="form-control selectPolice">
								<option selected value="<?= $data->policeId ?>"><?= $data->police ?></option>
							</select>
						</div>
						<div class="form-group col-md-3">
					...
					<div class="row">
						...
						<div class="form-group col-md-5">
							...
							<input class="form-control" type="text" name="accidentDetails"
								   value="<?= $data->accidentDetails ?>" id="accidentDetails">
						</div>
						<div class="form-group col-md-5">
					...
					<div class="row">
						<div class="form-group col-md-6">
							...
							<input class="form-control" type="text" name="policeOpinion"
								   value="<?= $data->policeOpinion ?>" id="policeOpinion">
						</div>
					</div>
					<div class="row">
						<div class="col-md-6">
						...
						<div class="col-md-6">
							...
							<div class="card-body" style="margin-top: 10px">
								<img width="250" class="img-responsive img-thumbnail center-block" id="preview"
									 src="<?= $data->ownerId != '' ? base_url('images/' . $data->id . '/' . $data->ownerId) :
